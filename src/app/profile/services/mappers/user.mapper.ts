...
const isUserDto = (obj: unknown): obj is User => {
    ...
    return (
        ...
        (typeof dto['numFriends'] === 'number' || dto['numFriends'] === null) &&
        (typeof dto['numComments'] === 'number' || dto['numComments'] === null) &&
        (typeof dto['numAchievements'] === 'number' || dto['numAchievements'] === null) &&
